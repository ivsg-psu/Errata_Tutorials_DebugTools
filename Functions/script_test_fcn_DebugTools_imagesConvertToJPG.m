% script_test_fcn_DebugTools_imagesConvertToJPG.m
% tests fcn_DebugTools_imagesConvertToJPG.m
...
sourceDirectory = fullfile(pwd,'Data','imagesConvertToJPG_source');
destinationDirectory = fullfile(pwd,'Data','imagesConvertToJPG_destination');
imageSize = [256 256];
...
%     fcn_DebugTools_imagesConvertToJPG(...
%     tempXYdata,...
%     start_definition,...
%     end_definition,...
