% script_test_fcn_DebugTools_md5ForStrings.m
% This is a script to exercise the function: fcn_DebugTools_md5ForStrings
% This test script was written on 2026_08_25 by S. Brennan
...
% - first write of the script using
...
figNum = 10001;
titleString = sprintf('DEMO case: basic call with basic inputs');
...
%% DEMO case: basic call with self-test inputs
figNum = 10001;
titleString = sprintf('DEMO case: basic call with self-test inputs');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); close(figNum);
...
%% DEMO case: basic call with array of string inputs
figNum = 10001;
titleString = sprintf('DEMO case: basic call with array of string inputs');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); close(figNum);

% Fill in inputs
inStrings = {"Example", 'test'};
flagOutputs = [];
...
% Check variable values
assert(strcmp(outHashes{1,1},"0a52730597fb4ffa01fc117d9e71e3a9"));
assert(strcmp(outHashes{1,2},"098f6bcd4621d373cade4e832627b4f6"));
