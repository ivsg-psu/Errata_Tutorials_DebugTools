% script_test_fcn_DebugTools_time2String.m
% Tests the function: fcn_DebugTools_time2String.m
...
%% DEMO case: basic call with input time
figNum = 10002;
titleString = sprintf('DEMO case: basic call with input time');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
% figure(figNum); clf;

timeInput = datetime(2014,1,1);
...
% Call the function
timeString = fcn_DebugTools_time2String([],([]));
