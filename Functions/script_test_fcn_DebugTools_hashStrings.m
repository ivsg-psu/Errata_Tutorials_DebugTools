% script_test_fcn_DebugTools_hashStrings.m
% This is a script to exercise the function: fcn_DebugTools_hashStrings
...
%% DEMO case: basic call with long string inputs
figNum = 10002;
titleString = sprintf('DEMO case: basic call with long string inputs');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); close(figNum);

% Fill in inputs
seedString = "Quiz01";
inStrings = 'This is a very long Example';
flagOutputs = [];
